...
class Game(pygame.sprite.Sprite):
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.JOYBUTTONDOWN:
                ...
                if self.char_looping_1:
                    ...
                    if pygame.joystick.Joystick(0).get_button(14) or pygame.joystick.Joystick(0).get_button(13):
                    ...
                    if pygame.joystick.Joystick(0).get_button(0):
                        ...
                        if self.select_char:
                            ...
                            self.players.append(Player(xp1, yp1, stalin32))

                # Choice p2
                if self.char_looping_2:
                    self.background = char_right_img_menu
                    if pygame.joystick.Joystick(1).get_button(14) or pygame.joystick.Joystick(0).get_button(13):
                        self.select_char = not self.select_char
    ...
    def check_events_game(self):
        # move players
        self.players[0].move(self.moving_left, self.moving_right, self.jump)
        self.players[1].move(self.moving_left2, self.moving_right2, self.jump2)
        if self.players[0].shoot:
            self.players[0].shoot_()
        if self.players[1].shoot:
            self.players[1].shoot_()

        for event in pygame.event.get():
            if pygame.event == pygame.QUIT:
                exit()
            if not event.type == pygame.JOYBUTTONUP:
                ...
                if pygame.joystick.Joystick(0).get_button(10):
                    self.players[0].shoot = True

                if pygame.joystick.Joystick(1).get_button(10):
                    self.players[1].shoot = True
                if pygame.joystick.Joystick(0).get_button(0):
                    self.jump = True
                    jetpack.play()
                if pygame.joystick.Joystick(1).get_button(13):
                    self.moving_left2 = True
                if pygame.joystick.Joystick(1).get_button(14):
